...
series_num = series.n(digits=15)
term1_num = term1.n(digits=15)
term2_num = term2.n(digits=15)
term3_num = term3.n(digits=15)
term4_num = term4.n(digits=15)

# Results
print("=" * 70)
print("CODE 1: TRUNCATED SERIES (NUMERICALLY STABLE) - SageMath")
print("=" * 70)
print(f"phi = {phi.n(digits=12)}")
print()
print("Individual terms:")
print(f"    360/phi^2           = {term1_num:.12f}")
print(f"    -2/phi^3            = {term2_num:.12f}")
print(f"    1/(3^5 * phi^5)     = {term3_num:.12f}")
print(f"    1/(7^7 * phi^7)     = {term4_num:.12f}")
print()
print(f"alpha^-1 (series)   = {series_num:.12f}")
print(f"alpha^-1 (CODATA)   = {alpha_inv_CODATA:.12f}")
print()
diff = series_num - alpha_inv_CODATA
